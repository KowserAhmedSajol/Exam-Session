...
class LimitlessMaterialServiceProvider extends ServiceProvider
{
    ...
    public function layouts()
    {
        ...
        \Illuminate\Support\Facades\Blade::component('sg-usermaster', \Themegenie\LimitlessMaterial\App\View\Components\Layouts\UserMaster::class);
    ...
    private function partials(){
        ...
        \Illuminate\Support\Facades\Blade::component('sg-userNavbar', \Themegenie\LimitlessMaterial\App\View\Components\Layouts\Partials\UserNavbar::class);
        ...
        \Illuminate\Support\Facades\Blade::component('sg-usersidebar', \Themegenie\LimitlessMaterial\App\View\Components\Layouts\Partials\UserSidebar::class);
