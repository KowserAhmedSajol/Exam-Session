...
Route::prefix('admin')->group(function () {
    ...
    // ------------------------------------------------------------------------
    //Pharmacy all pages with group------------------------------------------------------
    // ---------------------------------------------------------------------------
    Route::prefix('pharmacy')->group(function () {
        Route::view('/add','admin.pharmacy.add' )->name('pharmacy_add');
        Route::post('/insert', [PharmacyController::class, 'insert'])->name('pharmacy_insert');
        Route::get('/list', [PharmacyController::class, 'list'])->name('pharmacy_list');
        Route::post('/delete', [PharmacyController::class, 'delete'])->name('pharmacy_delete');
        Route::post('/edit', [PharmacyController::class, 'edit'])->name('pharmacy_edit');
        Route::post('/update', [PharmacyController::class, 'update'])->name('pharmacy_update');
    });
    ...
    // --------------------------------------------------------------------------------
    Route::prefix('doctor')->group(function () {
        Route::get('/userlist', [PharmacyController::class, 'userlist'])->name('user_pharmacy_list');
        Route::post('/userview', [PharmacyController::class, 'userview'])->name('user_pharmacy_view');
        Route::post('/medicineBuy', [PharmacyController::class, 'medicineBuy'])->name('user_pharmacy_buy');
        Route::post('/medicineBuylist', [PharmacyController::class, 'medicineBuylist'])->name('user_pharmacy_buy_list');
    });
